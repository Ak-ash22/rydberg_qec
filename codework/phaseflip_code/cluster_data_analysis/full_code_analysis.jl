...
function average_populations()
    ...
    base_path = "/scratch/roq68sum/5atoms_code/phaseflip_code/dephase_0.001/"
    file_pattern = "N_atoms=5_γ_dephase=0.001_Ntraj="
    ...
    # --- Save Averaged Data ---
    final_file_path = base_path * "N_atoms=5_γ_dephase=0.001_Ntraj=$(num_files)_avg.jld2"
