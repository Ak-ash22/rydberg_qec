...
function average_populations(dephase, case, ϕ)
    ...
    # --- Save Averaged Data ---
    final_file_path = "/scratch/roq68sum/5atoms_code/phaseflip_code/avg_analysis/dephase_$(dephase)/case$(case)/N_atoms=5_γ_dephase=$(dephase)_phase=$(ϕ)_Ntraj=$(num_files)_avg.jld2"
