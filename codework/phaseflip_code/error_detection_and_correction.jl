...
function main(N_trajectories::Int)
    ...
    for i in 1:1
        ...
        @time tout, ψt, jumps = timeevolution.mcwf_dynamic(tspan2,ψt[end],f,maxiters=1e9,seed=(N_trajectories*10000 + i),display_jumps=true)
        println("Applied Hadamards")

        @time tout, ψt, jumps = timeevolution.mcwf_dynamic(tspan3,ψt[end],f,maxiters=1e9,seed=(N_trajectories*10000 + i),display_jumps=true)
        println("Ancilla Drive Done")
